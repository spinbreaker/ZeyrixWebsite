...
import { AgentStep, ToolDetails, StepKind, StepStatus} from "@/src/types/chat";
...
export function Step({ kind, status, toolName, isLast, toolDetails }: AgentStep) {
  ...
  const isInteractive = kind === "tool_call";
